...
trait GeneratesUniqueTeamSlugs
{
    ...
    protected static function generateUniqueTeamSlug(string $name, ?int $excludeId = null): string
    {
        ...
        // A reserved slug is treated as already taken, so "Admin Supplies"
        // becomes admin-1 rather than shadowing the /admin routes.
        if ($existingSlugs->isEmpty() && ! in_array($defaultSlug, Team::RESERVED_SLUGS, strict: true)) {
            return $defaultSlug;
        }
