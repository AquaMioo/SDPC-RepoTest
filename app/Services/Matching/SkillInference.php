...
class SkillInference
{
    ...
    protected const DOMAIN_SKILLS = [
        ...
        'booking' => ['api-integration', 'mysql', 'uiux-design'],
        'appointment' => ['api-integration', 'mysql', 'uiux-design'],
        ...
        'ordering' => ['payment-integration', 'mysql', 'uiux-design'],
        'menu' => ['uiux-design', 'mysql'],
        'map' => ['api-integration'],
        ...
        'carinderia' => ['payment-integration', 'mysql', 'uiux-design'],
        'eatery' => ['payment-integration', 'mysql', 'uiux-design'],
        'canteen' => ['payment-integration', 'mysql', 'uiux-design'],
