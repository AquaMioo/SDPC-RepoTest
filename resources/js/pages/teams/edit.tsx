...
export default function TeamEdit({
    ...
    /*
     * A floating window over the Team page rather than a page of its own
     * (QA 2026-09-19). The address and every redirect to it stay as they
     * were; the controller sends the Team page's own payload as `background`,
     * so what shows behind the window is the real Team page. Closing the
     * window goes back to it.
     */
    return (
        <>
            <TeamsIndex {...background} />

            {/* After the page behind, so this title wins. */}
            ...
            <Dialog
                ...
                onOpenChange={(open) => {
                    if (!open) {
                        router.visit(index(), { preserveScroll: true });
                    }
                }}
            >
                <DialogContent className="max-h-[85vh] overflow-y-auto sm:max-w-2xl">
                    ...
                    <DialogDescription className="sr-only">
                        Rename the team, and manage its members and invitations.
                    </DialogDescription>
