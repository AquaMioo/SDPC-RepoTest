...
class DashboardTest extends TestCase
{
    ...
    public function test_guests_are_redirected_to_the_login_page()
    {
        ...
        $response = $this->get(route('dashboard', ['current_team' => $user->currentTeam]));
    ...
    public function test_clients_are_redirected_from_the_generic_dashboard_to_their_workspace()
    {
    ...
    public function test_dashboard_includes_pending_invitations_for_the_authenticated_user()
    {
        ...
        $response = $this
            ...
            ->get(route('dashboard', ['current_team' => $invitedUser->currentTeam]));
